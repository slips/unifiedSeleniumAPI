...
public class TablerowNodeTest extends AbstractNodeTest {

	private String TYPE = "tablerow";
	...
	public void setUp() throws Exception {
		...
		nodeUnderTest = new TablerowNode( super.webDriver, TYPE, NODE_NAME, AbstractNodeTest.LOCATOR);
	}
