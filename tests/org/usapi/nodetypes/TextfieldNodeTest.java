...
public class TextfieldNodeTest extends AbstractNodeTest {

	private String TYPE = "textfield";
	private String NODE_NAME = "tf1";
	
	@Before
	public void setUp() throws Exception {
		super.webDriver.setCallbackNode(this);
		nodeUnderTest = new TextfieldNode( super.webDriver, TYPE, NODE_NAME, AbstractNodeTest.LOCATOR);
	}
	...
	{
		nodeUnderTest.type("");
		assertEquals("clear,sendKeys", super.getCompositeMethodCalled());
	}
