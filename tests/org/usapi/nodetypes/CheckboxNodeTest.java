...
public class CheckboxNodeTest extends AbstractNodeTest {

	private String TYPE = "checkbox";
	private String NODE_NAME = "cb1";
	
	@Before
	public void setUp() throws Exception {
		super.webDriver.setCallbackNode(this);
		nodeUnderTest = new CheckboxNode( super.webDriver, TYPE, NODE_NAME, AbstractNodeTest.LOCATOR);
	}
	...
	{
		nodeUnderTest.check();
		assertEquals("getAttribute(checked),click", super.getWebElementMethodCalled());
	}
