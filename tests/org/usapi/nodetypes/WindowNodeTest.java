...
public class WindowNodeTest extends AbstractNodeTest {

	private String TYPE = "window";
	private String NODE_NAME = "window1";
	
	@Before
	public void setUp() throws Exception {
		super.selenium.setCallbackNode(this);
		super.webDriver.setCallbackNode(this);
		nodeUnderTest = new WindowNode( super.webDriver, TYPE, NODE_NAME, AbstractNodeTest.LOCATOR);
	...
	{
		nodeUnderTest.focus();
		assertEquals("switchTo,window", super.getWebDriverMethodCalled());
	}
	
	@Test
	public void testClose() throws USAPIException
	{
		((WindowNode)nodeUnderTest).close();
		assertEquals("close", super.getWebDriverMethodCalled());
	}
