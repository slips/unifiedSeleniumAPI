...
public class ButtonNodeTest extends AbstractNodeTest {

	private String TYPE = "button";
	private String NODE_NAME = "b1";
	...
	public void testNodeInstance() {
		//assertNotNull(nodeUnderTest.getSelenium());
		//assertEquals(nodeUnderTest.getSelenium(), super.selenium);
